...
public class TrataFormas {
    ...
    public void trataFormas() throws NaoExisteVolumeException
    {
            ...
            switch(formaAux.getNumLados())
            {
                case 0:
                    ...
                    if(formaAux.getNumDimensoes() == 2)
                    {
                        ...
                        try
                        {
                            System.out.println("Seu volume é: " + ((Circulo)formaAux).obterVolume() + ".");
                        }
                ...
                case 3:
                    ...
                    if(formaAux.getNumDimensoes() == 2)
                    {
                        ...
                        try
                        {
                            System.out.println("Seu volume é: " + ((Triangulo)formaAux).obterVolume() + ".");
                        }
                ...
                case 4:
                    ...
                    if(formaAux.getNumDimensoes() == 2)
                    {
                        ...
                        try
                        {
                            System.out.println("Seu volume é: " + ((Quadrado)formaAux).obterVolume() + ".");
                        }
                    ...
                    {
                        System.out.println("--------------------------------------------------------------------");
                        System.out.println("Cubo de aresta " + ((Cubo)formaAux).getTamanhoAresta() + ".");
                        System.out.println("Tipo da figura: Tridimensional.");
